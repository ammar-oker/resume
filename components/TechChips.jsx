...
const nextLogo = '/resume/svgs/nextjs.svg';
const nuxtLogo = '/resume/svgs/nuxtjs.svg';
const reduxLogo = '/resume/svgs/redux.svg';
const typescriptLogo = '/resume/svgs/typescript.svg';
const graphqlLogo = '/resume/svgs/graphql.svg';
const webpackLogo = '/resume/svgs/webpack.svg';
const apiIcon = '/resume/svgs/api.svg';
const pwaLogo = '/resume/svgs/pwa.svg';
const jestLogo = '/resume/svgs/jest.svg';
const cypressLogo = '/resume/svgs/cypress.svg';
const expressLogo = '/resume/svgs/expressjs.svg';
const jenkinsLogo = '/resume/svgs/jenkins.svg';
const sagaLogo = '/resume/svgs/redux-saga.svg';
